	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			for (int i = 0; i < studentCnt; i++) {
				...
				if (studentList[i].subjects != null) { // null 이 아닌경우
			...
			if (choice == 1) { 
				...
				studentList[studentCnt] = new Student8(); // studentList 안에 학생수
				studentList[studentCnt].name = name; // 이름설정
				studentCnt++; // 한번만 할게 아니기 때문에 계속돌리기
